...
@section('content')
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-1 text-2xl">Edit Berita</h6>
                    <p class="mb-4 text-slate-500 dark:text-zink-200">Update your photo and personal details here
                        easily.
                    </p>
                    <form action="{{ route('data-berita.update', $dataBerita->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                    ...
                                    @foreach ($dataKategoriBerita as $kategori)
                                        @can('view-kategori-berita', $kategori)
                                            <option value="{{ $kategori->id }}"
                                                {{ old('kategori_berita_id', $dataBerita->kategori_berita_id) == $kategori->id ? 'selected' : '' }}>
                            ...
                            <div class="xl:col-span-12">
                                ...
                                <textarea id="konten" name="konten"
                                    ...
                                    rows="6"> {{ old('konten', $dataBerita->konten) }}</textarea>
                            </div><!--end col-->

                            <div class="xl:col-span-6">
                                <label for="gambar" class="inline-block mb-2 text-base font-medium">Upload
                                    Gambar</label>
                                <div>
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <select id="status" name="status"
                                    ...
                                    @foreach ($statuses as $status)
                                        <option value="{{ $status }}"
                                            {{ old('status', $dataBerita->status) == $status ? 'selected' : '' }}>
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <input type="date" id="publishDate" name="tanggal_publish"
                                    ...
                                    placeholder="Pilih" flatpickr-input
                                    value="{{ old('tanggal_publish', $dataBerita->tanggal_publish) }}">
                            </div><!--end col-->
