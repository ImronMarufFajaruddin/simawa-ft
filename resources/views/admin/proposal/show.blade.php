                        ...
                        <table class="w-full">
                            ...
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                ...
                                <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                    {{ $dataProposal->kegiatan->nama_kegiatan }}
                                </td>
                            </tr>
                            ...
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                ...
                                <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                    <span
                                        class="inline-block px-2 py-1 text-xs font-semibold leading-none {{ $dataProposal->status == 'menunggu' ? 'text-yellow-600 bg-yellow-200' : ($dataProposal->status == 'revisi' ? 'text-custom-600 bg-custom-200' : ($dataProposal->status == 'ditolak' ? 'text-red-600 bg-red-200' : 'text-green-600 bg-green-200')) }} rounded">{{ $dataProposal->status }}</span>
                                </td>
                            </tr>
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">
