        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto ">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li class="text-slate-700 dark:text-zink-100">Landing Footer Setting</li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 flex items-center">
                        <h6 class="mb-4 text-xl grow">Landing Page Footer Setting</h6>
                        <div class="shrink-0">

                            <a type="button" href="{{ route('data-landings.footerCreate') }}"
                    ...
                    <table id="dataTable" class="bordered group" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Telp</th>
                                <th>Email</th>
                                <th>Media sosial link</th>
                                <th>Media sosial icon</th>
                                <th>Usefull Link</th>
                                <th>Usefull Link Title</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($dataFooter as $data)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button flex gap-1 justify-items-center">
                                            <a type="button" href="{{ route('data-landings.footerEdit', $data->id) }}"
