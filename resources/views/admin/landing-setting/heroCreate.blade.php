        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('data-landings.heroStore') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-12">
                                <label for="heroDeskripsi" class="block mb-2 text-base font-medium">Isi Deskripsi
                                    Hero</label>
                                <textarea id="heroDeskripsi" name="hero_deskripsi"></textarea>
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <input type="text" id="about_title" name="about_title"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    placeholder="Title Tentang Kami">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-12">
                                <label for="aboutDeskripsi" class="block mb-2 text-base font-medium">Isi Deskripsi Tentang
                                    Kami</label>
                                <textarea id="aboutDeskripsi" name="about"></textarea>
                            </div><!--end col-->
