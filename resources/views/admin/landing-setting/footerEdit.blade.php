                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="alamat" name="alamat"
                                    ...
                                    value="{{ old('alamat', $dataFooter->alamat) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="number" id="telp" name="telp"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('telp', $dataFooter->telp) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="email" id="email" name="email"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('email', $dataFooter->email) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="medsos_links" name="medsos_links"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('medsos_links', $dataFooter->medsos_links) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="medsos_icon" name="medsos_icon"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('medsos_icon', $dataFooter->medsos_icon) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="useful_links" name="useful_links"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('useful_links', $dataFooter->useful_links) }}">
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="useful_links_title" name="useful_links_title"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('useful_links_title', $dataFooter->useful_links_title) }}">
                            </div><!--end col-->
