            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                ...
                @can('superadmin-only')
                    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                        <div class="text-center card-body">
                            ...
                            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $userCount }}">0</span></h5>
                    ...
                    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                        <div class="text-center card-body">
                            ...
                            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $instansiCount }}">0</span>
                            </h5>
                            <p class="text-slate-500 dark:text-zink-200">Total Ormawa</p>
                        </div>
                    </div><!--end col-->
                @endcan
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $beritaCount }}">0</span></h5>
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $galeriCount }}">0</span>
                        </h5>
                        <p class="text-slate-500 dark:text-zink-200">Total Galeri</p>
                    </div>
                </div><!--end col-->
            </div>
            <!-- container-fluid -->
